...
# Talent Builds
With current tuning :archon~1: Archon and :voidweaver: Voidweaver are both viable in all forms of content. Typically Archon will end up winning in pure single target, but depending on fight timings Voidweaver can certainly make sense.
# Leveling
...
```
CIQAAAAAAAAAAAAAAAAAAAAAAAzmBAAAAAAAAAAAwYsYGjlxYmZzMmZYbmZMzMjNkZsYmGADwMLmhZzAQGjFAMmZGGzMzY2YmtlBYGMA
```
